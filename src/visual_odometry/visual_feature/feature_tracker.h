...
public:
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pub_depth_feature_1;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pub_depth_feature_2;
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pub_all_depth_cloud;
    ...
    node(node_in)
    {
        ...
        pub_depth_feature = node->create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/vins/depth/depth_feature", 5);
        pub_depth_feature_1 = node->create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/vins/depth/depth_feature_1", 5);
        pub_depth_feature_2 = node->create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/vins/depth/depth_feature_2", 5);
        pub_depth_image = node->create_publisher<sensor_msgs::msg::Image>(PROJECT_NAME + "/vins/depth/depth_image", 5);
        pub_depth_cloud = node->create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/vins/depth/depth_cloud", 5);
        pub_all_depth_cloud = node->create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/vins/depth/all_depth_cloud", 5);
        ...
        tf_buffer = std::make_unique<tf2_ros::Buffer>(node_in->get_clock());
                                           ...
                                           int cam_id)
    {
        ...
        {
            // TODO debug
            transform = tf_buffer->lookupTransform("vins_world", "vins_body_ros", stamp_cur, std::chrono::milliseconds(10));
        ...
        Eigen::Affine3f transNow = tf2::transformToEigen(transform).cast<float>();
