...
#include "factor/pose_local_parametrization.h"
...
class Estimator
{
  public:
    ...
    // for logging
    void setNode(const std::shared_ptr<rclcpp::Node>& in);
    void errorMsg(const std::string& err);
    ...
    // InitialEXRotation initial_ex_rotation;   // TODO per ora non lo faccio, non credo serva
